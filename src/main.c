...
int main(int argc, char** argv) {
	//dir , data , cfg
	argv[1] = "E:/github/darknet_windows/build/darknet";
	argv[2] = "x64/data/voc_d.data";
	argv[3] = "x64/cfg/yolov3-voc.cfg";
	/*argv[3] = "x64/darknet53.conv.74";
	argv[6] = "x64/cfg/voc.data";*/
	YoloTrain(argv[1], argv[2], argv[3]);

	//test_detector("voc.data", "yolov3.cfg", "yolov3.weights", "a.jpg", 0.4F, 0.5F, 0);
